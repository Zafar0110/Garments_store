    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        @foreach($sub_categories as $iteam)
                        <tr>
                            <td>{{ $iteam->id}}</td>
                            <td>{{ $iteam->name}}</td>
                            <td>{{ $iteam->categoryName}}</td>
                            <td>{{ $iteam->slug}}</td>
                            <td>
                            ...
                            <td>
                                <a href="{{route('sub-categories.edit',$iteam->id) }}">
                                ...
                                <a href="#" onClick="deleteSubCategory( {{ $iteam->id }})"
            ...
            <div class="card-footer clearfix">
                ...
                <!-- <ul class="pagination pagination m-0 float-right"> pagination
